...
function _initStandalone({
    ...
    setSDKVersion(r), t(new Component("database", ((e, {
        instanceIdentifier: t
    }) => repoManagerDatabaseFromApp(e.getProvider("app").getImmediate(), e.getProvider("auth-internal"), e.getProvider("app-check-internal"), t)), "PUBLIC").setMultipleInstances(!0)), n(d, "1.0.7", e), n(d, "1.0.7", "esm2017")
}();
export {
    DataSnapshot,
    Database,
